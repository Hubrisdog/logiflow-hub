...
const Auth = () => {
  ...
  const fillDemoAccount = (type: 'admin' | 'staff' | 'supplier') => {
    if (type === 'admin') {
      setSignInData({
      ...
      setSignInData({
        email: 'staff@logiflow.com', 
        password: 'staff123'
      });
    } else {
      setSignInData({
        email: 'supplier@logiflow.com',
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">Welcome to LogiFlow</h1>
                ...
                <div className="space-y-3">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    ...
                    <Button
                      ...
                      variant="outline"
                      size="sm"
                      onClick={() => fillDemoAccount('supplier')}
                      className="text-xs px-1"
                    >
                      Supplier Demo
                    </Button>
              ...
              <TabsContent value="signup" className="space-y-4">
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Select value={signUpData.role} onValueChange={(value: 'admin' | 'staff' | 'supplier') => setSignUpData({ ...signUpData, role: value })}>
                      <SelectTrigger>
