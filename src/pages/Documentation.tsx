      ...
      <header className="sticky top-0 z-50 bg-card border-b">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold">LogiFlow Documentation</h1>
            ...
            <section id="overview" className="scroll-mt-24">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Introduction to LogiFlow Inventory Management System
                  </CardDescription>
                </CardHeader>
                <CardContent className="prose prose-sm max-w-none dark:prose-invert">
                  <p>
                    LogiFlow is a comprehensive inventory management system designed to streamline 
            ...
            <section id="getting-started" className="scroll-mt-24">
              <Card>
                ...
                <CardContent className="prose prose-sm max-w-none dark:prose-invert">
                  ...
                  <ol>
                    <li>Navigate to the LogiFlow login page</li>
                    ...
                    <div className="grid gap-4 md:grid-cols-2 mt-4">
                      <Card>
                        ...
                        <CardContent className="text-sm">
                          <p><strong>Email:</strong> admin@logiflow.com</p>
                      ...
                      <Card>
                        ...
                        <CardContent className="text-sm">
                          <p><strong>Email:</strong> staff@logiflow.com</p>
