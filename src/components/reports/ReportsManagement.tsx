    ...
    switch (reportType) {
      ...
      case 'transactions':
        return transactions.map(t => ({
          ...
          'Type': t.transaction_type === 'add' ? 'Stock Added' :
                  t.transaction_type === 'remove' ? 'Stock Removed' :
                  t.transaction_type === 'adjust' ? 'Stock Adjusted' :
                  t.transaction_type === 'create' ? 'Item Created' :
                  t.transaction_type === 'update' ? 'Item Updated' :
                  t.transaction_type === 'delete' ? 'Item Deleted' : t.transaction_type,
          'Product': t.item?.name || 'N/A',
          'SKU': t.item?.sku || 'N/A',
          'Quantity Change': t.quantity_change.toString(),
          'Previous Qty': t.previous_quantity.toString(),
          'New Qty': t.new_quantity.toString(),
          'User': t.user?.name || t.user?.email || 'N/A',
          'Notes': t.notes || ''
        }));
