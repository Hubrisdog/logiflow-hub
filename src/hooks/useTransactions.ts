...
const getDemoTransactions = (): InventoryTransaction[] => [
  {
    ...
    user: { name: 'System Administrator', email: 'admin@logiflow.com' }
  },
  {
    id: 'demo-tx-2',
    item_id: 'demo-2',
    ...
    user: { name: 'Inventory Staff', email: 'staff@logiflow.com' }
  }
];
...
export const useTransactions = () => {
  ...
  const fetchTransactions = async () => {
    try {
      ...
      setTransactions((data as unknown as InventoryTransaction[]) || getDemoTransactions());
    } catch (error: unknown) {
