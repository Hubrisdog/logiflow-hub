...
export const generateManualPDF = () => {
  ...
  addParagraph('LogiFlow is a comprehensive inventory management system designed to streamline your business operations. It provides real-time tracking, automated alerts, and detailed analytics to help you manage your inventory efficiently.');
  ...
  addNumberedItem(1, 'Navigate to the LogiFlow login page');
  ...
  addBullet('Email: admin@logiflow.com');
  addBullet('Password: admin123');
  addSpace(3);
  addParagraph('Staff Account:');
  addBullet('Email: staff@logiflow.com');
  ...
  for (let i = 1; i <= totalPages; i++) {
    ...
    doc.setFont('helvetica', 'normal');
    doc.text(
      `LogiFlow User Manual - Page ${i} of ${totalPages}`,
      pageWidth / 2,
  ...
  doc.save('LogiFlow_User_Manual.pdf');
};
